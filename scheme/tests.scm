...
(if (not #t) (quote hello) (quote goodbye))
;expect goodbye
...
(begin (* 4 8 16) (+ 2 (- 10 5) 4 5) (print 'helloworld))
;expect helloworld

(define f (begin (display 'coolcode) (+ 3 30 300)))
;expect coolcodef
...
((lambda (x) (quote (1 2 3))) 2)
;expect (1 2 3)

((lambda (y) (lambda (x) (lambda (z) (* x x)) 2) 6) 3)
;expect 6
...
(define (g a b) (lambda (c) (+ (* a b) c)))
;expect g

(g 3 5)(10)
;expect Error: int is not callable: 10

(/ (+ (f 5 9 7) (f 9 11 10)) (f 2 3 5))
;expect 4
...
(define combo (lambda (x) (lambda (y) (* x (exponential x y)))))
;expect combo
...
(cond ((= 10 30) 'WRONG!)
      ((= 20 40) 'WRONGWRONG!)
      ((< 20 10) 'WRONGWRONGWRONG!)
      ((< 30 20) 'WRONGWRONGWRONGWRONG!)
      (else 'HELLOWORLD!))
;expect helloworld!


(cond ((> 10 30) 'INCORRECT)
      ((< 50 2) 'NOPE!)
      (else 'CORRECT (exponential 3 3))
  )
;expect 27

(cond ((> 30 5) 'HELLOTHERE!)
      (else (* (+ (exponetial 4 4) (exponential 5 5) (exponential 6 6)) 5))
)
;expect hellothere!
...
(define x 9)
(* (let ((x 100)) (let ((x 2000)) (let ((x 30000)) (* x 1)))) x)
;expect 270000

(define x 9)
(let ((x (lambda (x) (x 30000)))) x)
;expect (lambda (x) (x 30000))

;Problem 16
(define x 25)
;expect x

(define func (mu () (/ (* a b c) d)))
;expect func

(define other-func (lambda () (define a 20) (define c 30) (define d 40) (define b 50) (func)))
;expect other-func
